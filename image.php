		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<ul>
				<?php
								...
								printf( __( '<li time class="entry-date">%2$s</li> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s px</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>', 'baylys' ),
...
?>
		...
		<nav id="nav-image"  class="clearfix">
			<div class="previous-image"><?php previous_image_link( '%link', __( '&laquo; Previous Image', 'baylys' )); ?></div>
			<div class="next-image"><?php next_image_link(  '%link', __( 'Next Image &raquo;', 'baylys' ) ); ?></div>
		</nav><!-- #image-nav -->
